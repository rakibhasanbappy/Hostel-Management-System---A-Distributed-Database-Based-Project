...
CREATE OR REPLACE PROCEDURE showAllStudent
IS
...
BEGIN
	...
	DBMS_OUTPUT.PUT_LINE('Here are the detailed information of all students: ');
	
	for x in (select sid, sname, class, section, house, fatherName into i, n, c, s,  h, fn from student)
		LOOP
			i:=x.sid;
			n:=x.sname;
			c:=x.class;
